...
export const categoryCatalog = {
  Men: [
    ...
    { id: 'men-6', image: menCategory6, label: 'Jeans' },
    { id: 'men-7', image: menCategory7, label: 'Formals' },
    { id: 'men-8', image: menCategory8, label: 'Sleeveless Gym Tank' },
    { id: 'men-9', image: menCategory9, label: 'Hoodies & Jackets' },
  ],
  Women: [
    { id: 'women-1', image: womenCategory1, label: 'T-Shirts' },
    { id: 'women-2', image: womenCategory2, label: 'Jogger Pants' },
    { id: 'women-3', image: womenCategory3, label: 'Polo T-Shirt' },
    { id: 'women-4', image: womenCategory4, label: 'Shorts' },
    { id: 'women-5', image: womenCategory5, label: 'Sarees' },
    { id: 'women-6', image: womenCategory6, label: 'Salwar Suit' },
    { id: 'women-7', image: womenCategory7, label: 'Lounge Wear Set' },
    { id: 'women-8', image: womenCategory8, label: 'Gym Wear' },
    { id: 'women-9', image: womenCategory9, label: 'Ethnic Stole' },
  ],
  Kids: [
    { id: 'kids-1', image: kidsCategory1, label: 'Co-ord Set' },
    { id: 'kids-2', image: kidsCategory2, label: 'Cargo Pants' },
    { id: 'kids-3', image: kidsCategory3, label: 'Polo T-Shirt' },
    { id: 'kids-4', image: kidsCategory4, label: 'Casual Co-ord Set' },
    { id: 'kids-5', image: kidsCategory5, label: 'T-Shirt & Jeans' },
    { id: 'kids-6', image: kidsCategory6, label: 'Ethnic Kurta Set' },
    { id: 'kids-7', image: kidsCategory7, label: 'Formal Suit Set' },
    { id: 'kids-8', image: kidsCategory8, label: 'Traditionals' },
