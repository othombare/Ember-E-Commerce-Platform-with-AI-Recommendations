...
export const categoryCatalog = {
  Men: [
    ...
    { id: 'men-4', image: menCategory4, label: 'Cargoes' },
    { id: 'men-5', image: menCategory5, label: 'Active Wear' },
    { id: 'men-6', image: menCategory6, label: 'Hoodies & Jackets' },
    { id: 'men-7', image: menCategory7, label: 'Shirts' },
    { id: 'men-8', image: menCategory8, label: 'Shorts' },
    { id: 'men-9', image: menCategory9, label: 'Formals' },
  ],
  Women: [
    { id: 'women-1', image: womenCategory1, label: 'Sarees' },
    { id: 'women-2', image: womenCategory2, label: 'Kurtas & Suits' },
    { id: 'women-3', image: womenCategory3, label: 'Dupatta' },
    { id: 'women-4', image: womenCategory4, label: 'Shorts' },
    { id: 'women-5', image: womenCategory5, label: 'Active Wear' },
    { id: 'women-6', image: womenCategory6, label: 'T-Shirts' },
    { id: 'women-7', image: womenCategory7, label: 'Shirts' },
    { id: 'women-8', image: womenCategory8, label: 'Formals' },
    { id: 'women-9', image: womenCategory9, label: 'Party Wear' },
  ],
  Kids: [
    { id: 'kids-1', image: kidsCategory1, label: 'T-Shirts' },
    { id: 'kids-2', image: kidsCategory2, label: 'Jeans' },
    { id: 'kids-3', image: kidsCategory3, label: 'Shirts' },
    { id: 'kids-4', image: kidsCategory4, label: 'Shorts' },
    { id: 'kids-5', image: kidsCategory5, label: 'Active Wear' },
    { id: 'kids-6', image: kidsCategory6, label: 'Joggers' },
    { id: 'kids-7', image: kidsCategory7, label: 'Formals' },
    { id: 'kids-8', image: kidsCategory8, label: 'Party Wear' },
