        ...
        <div className="flex h-full flex-col overflow-y-auto px-6 py-6 md:px-12 md:py-8">
          ...
          >
            <label className="text-[19px] font-semibold text-[#4a4742]">
              Name
              <input className={inputClassName} type="text" placeholder="Enter your full name" />
            </label>
            ...
            <label className="text-[19px] font-semibold text-[#4a4742]">
              ...
              <input
                className={inputClassName}
                type="password"
                placeholder="Re-enter your password so you wont forget"
              />
            </label>

            <label className="mt-1 flex items-center gap-3 text-[15px] text-[#5d5952]">
            ...
            >
              <svg aria-hidden="true" className="size-6" viewBox="0 0 24 24">
                ...
                <path
                  ...
                  fill="#34A853"
                />
                <path d="M21.35 11.1h-9.18v2.98h5.26c-.12.8-.6 1.96-1.74 2.74l2.74 2.3c1.64-1.51 2.92-3.88 2.92-7.02 0-.6-.06-1.05-.14-1.5Z" fill="#FBBC05" />
              </svg>
              Sign In with Google
            </button>
          </form>
