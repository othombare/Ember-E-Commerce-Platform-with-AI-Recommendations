...
import { getCartButtonLabel, getWishlistButtonLabel, isProductInCart } from '../../utils/productActionState'
...
function Favourites() {
  ...
  const { addToWishlist, favouriteProductIds, isInWishlist, removeFromFavourites } = useSavedItems()
              ...
              <article className="border border-[#dfdfdf] bg-white p-2" key={item.id}>
                ...
                <div className="mt-2 grid gap-2">
                  ...
                  <button
                    ...
                    type="button"
                  >
                    {getWishlistButtonLabel(isInWishlist(item.id))}
                  </button>
                  <button
